...
#include <jni.h>
/* Header for class com_example_lederui_developmenttest_data_PrinterInterface */

#ifndef _Included_com_example_lederui_developmenttest_data_PrinterInterface
#define _Included_com_example_lederui_developmenttest_data_PrinterInterface
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_example_lederui_developmenttest_data_PrinterInterface_SetAllcutOrHalfcut
  (JNIEnv *, jobject, jint);
 ...
 * Signature: (II)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_example_lederui_developmenttest_data_PrinterInterface_PrintCodePaper
  (JNIEnv *, jobject, jint, jint);
 ...
 * Signature: (II)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_example_lederui_developmenttest_data_PrinterInterface_PrintContinue
  (JNIEnv *, jobject, jint, jint);
 ...
 * Signature: (I)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_example_lederui_developmenttest_data_PrinterInterface_PrintSpeedTest
  (JNIEnv *, jobject, jint);
 ...
 * Signature: (I)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_example_lederui_developmenttest_data_PrinterInterface_PrintCutPaperSpeed
  (JNIEnv *, jobject, jint);
