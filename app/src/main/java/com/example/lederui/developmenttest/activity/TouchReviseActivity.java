...
/**
 * Created by holyminier on 2017/5/27.
 */

public class TouchReviseActivity extends AppCompatActivity {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (Math.abs(cal.xfb[screen_pos] - tmpx) > 15 &&
                    ...
                    Toast.makeText(TouchReviseActivity.this, "无效的校准点", Toast.LENGTH_LONG).show();
                    return false;
                }
                ...
                if (screen_pos == 4) {
                    ...
                    if (ret) {
                        ...
                        Toast.makeText(TouchReviseActivity.this, "校正完毕!", Toast.LENGTH_LONG).show();
